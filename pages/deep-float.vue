<template>
    <main id="saaad-laboratory">
          ...
          <iframe src="https://labs.piks-l.fr/anciens-travaux/saaaad-deepfloat/" style="border:none; width:calc(100vw - 200px); height:calc(100vh)" title="Iframe Example"></iframe> 
